        ...
        click: function(e){
            ...
            **/
            ...
            if(e.dataPoint.typename=='productivity'){
                ...
                setTimeout(function(){ 
                    window.location.href = 'https://dx360.konicaminolta.co.uk/productivity-and-collaboration';
                }, 2000);
            }
                ...
                setTimeout(function(){ 
                    window.location.href = 'https://dx360.konicaminolta.co.uk/security-and-compliance';
                }, 2000);
            }
                ...
                setTimeout(function(){ 
                    window.location.href = 'https://dx360.konicaminolta.co.uk/mobility';
                }, 2000);
                ...
                setTimeout(function(){ 
                    window.location.href = 'https://dx360.konicaminolta.co.uk/flexibility-efficiency-and-sustainability';
                }, 2000);
            }
                ...
                setTimeout(function(){ 
                    window.location.href = 'https://dx360.konicaminolta.co.uk/analytics-and-intelligence';
                }, 2000);
            }else{
                document.getElementById('productivity').style.display = 'none';
                document.getElementById('security').style.display = 'none';
